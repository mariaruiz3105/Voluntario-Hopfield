//código a parte para guardar m y T para muchos valores de T 3 patrones
#include <iostream>
#include <cmath>
#include <random>
#include <chrono>
...
int main(){
    ...
    mkdir("varios_patrones/con_deformacion", 0777);
    ...
    double sumatoria_H;
    double deltaH;
    ofstream archivo_final("varios_patrones/con_deformacion/m_vs_T.txt");
    ...
    for (double T :temperaturas){
        ...
        for (i=0; i<pasos; i++){
            ...
            if (i==pasos-1){
                ...
                archivo_final << T << "\t" << abs(m_solap[0]) << "\t" << abs(m_solap[1]) << "\t" << abs(m_solap[2]) << endl;
            }
        }
